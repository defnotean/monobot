 ...
 */
export async function recordSelfFact({ fact, category = "misc" } = {}) {
  ...
  const { _getData, _markOpinionsDirty } = await import("./personality.js");
 ...
 */
export async function listSelfFacts({ category = null, limit = MAX_FACTS } = {}) {
 ...
 */
export async function forgetSelfFact(search) {
 ...
 */
export async function buildSelfCanonContext({ limit = 15 } = {}) {
