...
const _unicodeMap = (() => {
  ...
  // Subscript letters
  const sub: [string, string][] = [["ₐ","a"],["ₑ","e"],["ₕ","h"],["ᵢ","i"],["ⱼ","j"],["ₖ","k"],["ₗ","l"],["ₘ","m"],["ₙ","n"],["ₒ","o"],["ₚ","p"],["ᵣ","r"],["ₛ","s"],["ₜ","t"],["ᵤ","u"],["ᵥ","v"],["ₓ","x"]];
  for (const [k, v] of sub) m.set(k, v);
  // Superscript letters
  const sup: [string, string][] = [["ᵃ","a"],["ᵇ","b"],["ᶜ","c"],["ᵈ","d"],["ᵉ","e"],["ᶠ","f"],["ᵍ","g"],["ʰ","h"],["ⁱ","i"],["ʲ","j"],["ᵏ","k"],["ˡ","l"],["ᵐ","m"],["ⁿ","n"],["ᵒ","o"],["ᵖ","p"],["ʳ","r"],["ˢ","s"],["ᵗ","t"],["ᵘ","u"],["ᵛ","v"],["ʷ","w"],["ˣ","x"],["ʸ","y"],["ᶻ","z"]];
  ...
  const lookalikes: [string, string][] = [["α","a"],["β","b"],["є","e"],["η","n"],["ι","i"],["σ","o"],["τ","t"],["υ","u"],["ν","v"],["ω","w"],["ρ","p"],["γ","y"],["д","d"],["к","k"],["м","m"],["н","h"],["р","p"],["с","c"],["у","y"],["х","x"]];
