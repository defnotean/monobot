...
export async function handleApiRequest(req, res) {
  ...
  const allowedOrigins = [process.env.RENDER_EXTERNAL_URL, "https://irene-bot.onrender.com", "https://your-dashboard.example.com", process.env.DASHBOARD_URL].filter(Boolean);
  ...
  try {
    ...
    // request body elsewhere in this handler.
