...
- Music/voice: play_music/skip_song/stop_music/pause_music/resume_music/music_queue/now_playing/set_volume/toggle_loop/shuffle_queue/music_filter; /filter and /dj exist. For text-to-speech/TTS use toggle_tts/set_tts_voice/say_tts. For ElevenLabs owner media use generate_sound_effect/generate_dialogue_audio/clean_audio_attachment/transcribe_audio_attachment. For spoken wake-word listening/STT use toggle_voice_listen or /listen. Never use voice listening to turn on TTS. Lyrics requests use start_lyrics_mode/auto_lyrics_mode/stop_lyrics_mode.
